...
The plot shows that participation is generally greatest in areas that have low levels of deprivation and low levels of ethnic density (bottom left), and lowest in areas with high levels of deprivation and high ethnic density (top-right). Areas with high deprivation, or high ethnic density, tended to have low participation. The relationship was robust to Urban Major areas and Urban Minor areas but did not hold in Rural areas where data was more limited. It is important to note that we do not control for other factors, such as the age of residents or the population density and there are therefore many confounding factors.
...
df <-  merge(df,lsoa_ruralurban) %>% 
 ...
 #                                   probs = c(0,0.5,1)),   # c(0,0.25,0.5,0.75,1)
 #                          include.lowest = T,
